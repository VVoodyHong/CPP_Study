//2-3. pointer_2dimensionArray.cpp
...
int main(void) {
	...
	*/
	...
	/*
	d[0] = a[0]; // 왼쪽 피연산자인 d[0]이 l-value가 아니므로 error 발생
	d[1] = a[1]; // 왼쪽 피연산자인 d[0]이 l-value가 아니므로 error 발생
	d[2] = a[2]; // 왼쪽 피연산자인 d[0]이 l-value가 아니므로 error 발생
	*/
